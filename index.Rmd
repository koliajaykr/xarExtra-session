...
meta() %>%
  ...
  meta_social(
    ...
    url = "https://xarextra.netlify.app/",
    image = "https://xarextra.netlify.app/images/social-card.png",
    og_type = "talk",
    og_author = "Ajay Koli",
...
## .green.b[Ajay Koli | 30 April 2022 | R-Ladies Urmia]
...
Dr Ajay Kumar Koli<br>Head of School of Data Science<br>`r icons::fontawesome("briefcase")` [Nalanda Academy](https://nalanda-academy.org/) - Wardha<br>`r icons::fontawesome("twitter")` [@ajay_kolii](https://twitter.com/ajay_kolii)
...
```{r ref.label="plot-code", out.width="100%", fig.width=12, fig.height=4}
...
xaringanExtra::use_logo(
  image_url = "images/ajaykoli.png",
  link_url = "https://koliajay.netlify.app/",
  width = "100px",
  height = "100px"
)
```
...
- to highlight a few particular codes
...
- to add presentation progress bar
...
# Thank you everyone!!<br>`r emo::ji("smile")`